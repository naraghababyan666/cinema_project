          ...
          <div class="row name__person">
            ...
            <div class="col col-xl-8">
              <div class="inputBar">
                ...
                <p
                  :class="{
                    red_star: $v.personName.$invalid,
                    green_star: !$v.personName.$invalid,
                  }"
          ...
          <div class="row name__person">
            ...
            <div class="col col-xl-8">
              <div class="inputBar">
                ...
                <p
                  :class="{
                    red_star: $v.name_theatre.$invalid,
                    green_star: !$v.name_theatre.$invalid,
                  }"
                  class="align-self-center"
                >
                  *
            ...
            <div class="col col-xl-8">
              ...
              >
                <div class="current__document">
                  ...
                  <p
                    :class="{
                      red_star: $v.documents.first_doc_text.$invalid,
                      green_star: !$v.documents.first_doc_text.$invalid,
                    }"
                    class="absoluteStar"
                  >
                    *
              ...
              <div class="person__adding">
                ...
                <div class="add__person">
                  <button
                    ...
                    v-for="(item, key) in delete__person"
                    :key="key"
                ...
                >
                  <div class="current__info">
                    <div class="current__info__name">
                      ...
                      <p
                        :class="{
                          red_star: item.person_name.$invalid,
                          green_star: !item.person_name.$invalid,
                        }"
                        class="absoluteStar"
                      >
                        *
                    ...
                    <div class="current__info__screen">
                      <div style="display: flex; align-items: center">
                        ...
                        <img
                          ...
                          width="35"
                          class="visual_photo"
                          :src="item.person_photo_visual.$model"
                        />
                      </div>
                      <div>
                        <input
                        ...
                        <label :for="item.id.$model"
                          ><img
                            src="../../assets/images/dashboard/paperclip.png"
                        /></label>
                      </div>
                    </div>
                  </div>
              ...
              >
                <div class="name_hall">
                  <div class="name_hall__title">
                    ...
                    <span
                      :class="{
                        red_star: item.name_hall.$invalid,
                        green_star: !item.name_hall.$invalid,
                      }"
                      class="align-self-center"
                ...
                <div class="scheme">
                  <div style="display: flex; align-items: center">
                    ...
                    <img
                      ...
                      width="35"
                      class="visual_photo"
                      :src="item.hall_scheme_photo_visual.$model"
                    />
                  </div>
                  <input
                    type="file"
                ...
                <div class="scheme_description">
                  <div class="row_count">
                    <label for="new_hall_row_count" style="text-align: left"
                      >Количество рядов</label
                    >
                    <span
                      :class="{
                        red_star: item.row_count.$invalid,
                        green_star: !item.row_count.$invalid,
                      }"
                      class="align-self-center"
                    ...
                    >
                    <input
                      id="new_hall_row_count"
                      type="number"
                      class="dark__input"
                      v-model="item.row_count.$model"
                    />
                  </div>
                  <div class="seat_count" style="margin-left: 5px">
                    <label for="new_hall_seat_count"
                      >Количество мест в ряду</label
                    >
                    <span
                      :class="{
                        red_star: item.seat_count.$invalid,
                        green_star: !item.seat_count.$invalid,
                      }"
                      class="align-self-center"
                      style="margin-left: 5px; margin-top: 5px"
                      >*</span
                    >
                    <input
                      id="new_hall_seat_count"
                      type="number"
                      class="dark__input"
                      v-model="item.seat_count.$model"
                    />
                  </div>
                </div>
<!--                <div class="desc">-->
...
<!--                    <p-->
<!--                      :class="{-->
<!--                        red_star: item.hall_width.$invalid,-->
<!--                        green_star: !item.hall_width.$invalid,-->
<!--                      }"-->
<!--                      class="absoluteStar"-->
<!--                    >-->
<!--                      *-->
...
<!--                    <p-->
<!--                      :class="{-->
<!--                        red_star: item.hall_length.$invalid,-->
<!--                        green_star: !item.hall_length.$invalid,-->
<!--                      }"-->
<!--                      class="absoluteStar"-->
<!--                    >-->
<!--                      *-->
...
<!--                    <p-->
<!--                      :class="{-->
<!--                        red_star: item.hall_height.$invalid,-->
<!--                        green_star: !item.hall_height.$invalid,-->
<!--                      }"-->
<!--                      class="absoluteStar"-->
<!--                    >-->
<!--                      *-->
...
<!--                      width="35"-->
<!--                      class="visual_photo"-->
<!--                      :src="item.hall_cresel_photo_visual.$model"-->
<!--                    />-->
<!--                  </div>-->
<!--                  <input-->
<!--                    type="file"-->
...
<!--                </div>-->
                ...
                <div class="more__description">
                  ...
                  <p
                    :class="{
                      red_star: item.hall_screen_width.$invalid,
                      green_star: !item.hall_screen_width.$invalid,
                    }"
                    class="absoluteStar"
                  >
                    *
                  ...
                  <p
                    :class="{
                      red_star: item.hall_screen_length.$invalid,
                      green_star: !item.hall_screen_length.$invalid,
                    }"
                    class="absoluteStar"
                  >
                    *
                ...
                <div class="voice__upload" style="align-items: center">
                  ...
                  <p
                      :class="{
                      red_star: item.hall_voice_desc.$invalid,
                      green_star: !item.hall_voice_desc.$invalid,
                    }"
                      class="absoluteStar"
                  >
                    *
                  ...
                  <img
                      ...
                      width="35"
                      class="visual_photo"
                      :src="item.hall_voice_photo_visual.$model"
                  />
                  <input
                      type="file"
                      style="display: none"
...
<!--                      width="35"-->
<!--                      class="visual_photo"-->
<!--                      :src="item.hall_photo_visual.$model"-->
<!--                    />-->
<!--                  </div>-->
...
<!--                </div>-->
          ...
          <div class="row contract">
            ...
            >
              ...
              <label for="checkbox" class="checkbox-doc"
                >Согласен на условия договора</label
              >
            </div>
        ...
        <div class="btn" @click.prevent="check">
          <button class="btn_success">Отправить</button>
        </div>
        <p class="frontValid" v-show="frontValid">
...
export default {
      ...
      add_hall: [
        {
          ...
          hall_length: "",
          hall_height: "",
          hall_cresel_photo: "hall_cresel_photo",
          hall_cresel_photo_visual:
            "data:image/jpeg;base64,",
          hall_voice_desc: "",
  ...
  methods: {
    ...
    delete_form(key) {
      this.delete__person.splice(key, 1);
    ...
    check() {
      ...
      if (this.$v.$invalid) {
        ...
        files.append(
          "new_hall_row_count",
          JSON.stringify(this.new_hall_row_count)
        );
        files.append(
          "new_hall_seat_count",
          JSON.stringify(this.new_hall_seat_count)
        );
        files.append("new_hall_width", JSON.stringify(this.new_hall_width));
        files.append("new_hall_length", JSON.stringify(this.new_hall_length));
        files.append("new_hall_height", JSON.stringify(this.new_hall_height));
        files.append(
          "new_hall_voice_desc",
          JSON.stringify(this.new_hall_voice_desc)
        );
        files.append(
          "new_hall_screen_width",
          JSON.stringify(this.new_hall_screen_width)
        );
        files.append(
          "new_hall_screen_length",
          JSON.stringify(this.new_hall_screen_length)
        );
...
.address_all .flex_container .region,
.address_all .flex_container .city {
  display: flex;
  align-items: center;
  justify-content: center;
}
.address_all .flex_container .region p,
.address_all .flex_container .city p,
.address_all .house p {
  margin-right: 10px;
}
...
.add__hall .col-xl-8 .add__hall_description .scheme_description,
.add__hall .col-xl-8 .add__hall_description .scheme_description > * {
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.description__hall .col-xl-8 .description .first_section .scheme,
.description__hall .col-xl-8 .description .first_section .scheme > * {
  display: flex;
  align-items: center;
  margin-bottom: 10px;
