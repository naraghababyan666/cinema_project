        ...
        <div class="row">
          <div class="card">
            ...
            <img
              ...
              alt="."
            />
            <div class="buttons" @click="checkAuth">
              <router-link
                :to="{ name: 'upload-docs'}"
          ...
          <div class="card">
            ...
            />
            <div class="buttons" @click="checkAuth" >
              <router-link to="/cinema/dashboard" class="btn text-white text-semi-bold"
...
export default {
  ...
  mounted() {
    this.localToken = localStorage.getItem('access_token')
    document.title = "Extra Cinema | Для кинозала";
    // axios.post(process.env.VUE_APP_API_URL + "api/cinema/for-halls").then((res) => {
    //   console.log(res)
    // })
  },
  methods: {
