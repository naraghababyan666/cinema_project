<tr>
    ...
    <td>
        <?php echo e($item->organization_name); ?>
    ...
    <td>
        <?php echo e($item->payment_account); ?>

    </td>
    <td>
        <?php echo e($item->correspondent_account); ?>
    ...
    <td class="text-center">
        ...
        <?php else: ?>
            <div style="display: flex; justify-content: center;">
                <form action="<?php echo e(route('admin.payment_to_requisite.change', ['id' => $item->id, 'value' => 1, 'user_id' => $item->user->id, 'wanted_total' => $item->wanted_total])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('admin.payment_to_requisite.change', ['id' => $item->id, 'value' => 2])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('POST'); ?>
                    <button type='submit' class="text-primary mx-2" style="border: none; background: transparent">
...
<?php /**PATH C:\OpenServer\domains\extra_cinema\cinema_back\resources\views/admin/payment_to_requisite/_table.blade.php ENDPATH**/ ?>