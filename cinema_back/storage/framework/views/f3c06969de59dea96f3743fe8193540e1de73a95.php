                        ...
                        <form action="<?php if(isset($item)): ?><?php echo e(route('admin.seances.update',['id'=>$item->id])); ?><?php else: ?><?php echo e(route('admin.seances.store')); ?><?php endif; ?>" class="was-validated" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="hall_id" class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" required>
                                                ...
                                                <?php $__currentLoopData = $halls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($hall->id); ?>" <?php if(isset($item) and $item->hall_id == $hall->id): ?> selected <?php endif; ?>><?php echo e($hall->name_hall); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        <?php echo $__env->make('admin._include.form.input',['data'=>'day','type'=>'date','label'=>'Дата и время','placeholder'=>'Введите данные','length'=>10,'required'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                    <div class="col-md-2 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <?php echo $__env->make('admin._include.form.input',['data'=>'duration_advertising','type'=>'number','label'=>'Рекламный блок, мин.','placeholder'=>'Введите данные','length'=>10], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <?php echo $__env->make('admin._include.form.input',['data'=>'tickets_price','type'=>'number','label'=>'Цена билета, руб.','placeholder'=>'Введите данные','length'=>10,'required'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Рекламы</label>
                                        <select name="advertisement_id[]" class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="advertisement_id" tabindex="-1" aria-hidden="true" data-placeholder=" Сделайте выбор" multiple required>
                                            ...
                                            <?php $__currentLoopData = $advertisement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertising): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value=<?php echo e($advertising->id); ?> <?php if(isset($item) and $item->user_id == null): ?> selected <?php endif; ?>><?php echo e($advertising->title); ?></option>
...
<?php echo $__env->make('admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\extra_cinema\cinema_back\resources\views/admin/seances/create.blade.php ENDPATH**/ ?>