<li class="nav-item has-treeview @if(Route::is('*.documents_eais.*')) menu-open @else menu-hide @endif">
    <a href="{{ route('admin.document_eais.index') }}" class="nav-link @if(Route::is('*.document_eais.*')) active @endif">
