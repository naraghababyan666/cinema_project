<li class="nav-item has-treeview @if(Route::is('*.projectors.*')) menu-open @else menu-hide @endif">
    <a href="{{ route('admin.projectors.index') }}" class="nav-link @if(Route::is('*.projectors.*')) active @endif">
