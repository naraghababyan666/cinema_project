                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="hall_id" class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" required>
                                                ...
                                                @foreach($halls as $hall)
                                                    <option value="{{ $hall->id }}" @if(isset($item) and $item->hall_id == $hall->id) selected @endif>{{ $hall->name_hall }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
{{--                                    </div>--}}
                                    <div class="col-md-2 mb-3">
                                        @include('admin._include.form.input',['data'=>'day','type'=>'date','label'=>'Дата и время','placeholder'=>'Введите данные','length'=>10,'required'=>true])
                                    </div>
                                    <div class="col-md-2 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        @include('admin._include.form.input',['data'=>'duration_advertising','type'=>'number','label'=>'Рекламный блок, мин.','placeholder'=>'Введите данные','length'=>10])
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        @include('admin._include.form.input',['data'=>'tickets_price','type'=>'number','label'=>'Цена билета, руб.','placeholder'=>'Введите данные','length'=>10,'required'=>true])
                                    </div>
