...
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" name="{{ $data }}" id="{{ $data }}" aria-describedby="{{ $data }}" accept=".mp4,.avi" @isset($required) @empty($item->$data) required @endempty @endisset>
